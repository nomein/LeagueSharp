...
namespace Support
{
    internal class MetaHandler
    {
        ...
        static readonly ItemId[] SRShopList = { ItemId.Mana_Potion, ItemId.Morellonomicon, ItemId.Zhonyas_Hourglass, ItemId.Rabadons_Deathcap, ItemId.Frost_Queens_Claim, ItemId.Rod_of_Ages, ItemId.Sorcerers_Shoes };
        ...
        public static void DoChecks()
        {
            ...
            if (map != null && map.Type == Utility.Map.MapType.SummonersRift)
            {
                ...
                if (Autoplay.Bot.InFountain() && (Autoplay.Bot.Gold == 475 || Autoplay.Bot.Gold == 515))
                {
                    ...
                    Autoplay.Bot.BuyItem(ItemId.Mana_Potion);
                }
